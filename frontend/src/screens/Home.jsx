...
export default function Home({ go, buy, joinChallenge, joinedChallenges }) {
  ...
  return (
    <div className="pad">
      ...
      <FeedCard tag="Défi" title="Challenge Printemps" desc="Roule 300 km ce mois-ci et débloque -15% sur ta prochaine gomme route." reward="+50 pts" alreadyJoined={joinedChallenges.has('spring300')} onAction={() => joinChallenge({ id: 'spring300', tag: 'Défi', title: 'Challenge Printemps', desc: 'Roule 300 km ce mois-ci et débloque -15% sur ta prochaine gomme route.', reward: '+50 pts', points: 50 })} />
    </div>
  );
}
